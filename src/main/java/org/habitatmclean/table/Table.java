...
public abstract class Table {
     ...
     * @param modal a modal object to add to the table
     */
    Table(String[] HEADERS, Modal modal, boolean flag, List entities) {
...
//        table.append(SEARCH_FORM_END);
    ...
    static class TableRow {
        ...
        final String LOG = "<button id=\"logButton\" type=\"button\" class=\"btn btn-info btn-sm btn-log d-print-none\">Log</button></td>";
